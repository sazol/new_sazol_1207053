...
///////////////////////////////pointProgram/////////////////////////////////	
		        ...
		        program = ShaderHelper.linkProgram(vertexShader1, fragmentShader1);
  ...
  //      Matrix.translateM(mLightModelMatrix, 0, 0.0f, 0.0f, 2.0f);
    ...
    private void drawLight()
    {
       ...
       // GLES20.glDisableVertexAttribArray(pointPositionHandle);  
        ...
        Matrix.multiplyMM(FprojectionMatrix, 0, ViewMatrix, 0, mLightModelMatrix, 0);
        Matrix.multiplyMM(FprojectionMatrix, 0, projectionMatrix, 0, FprojectionMatrix, 0);
